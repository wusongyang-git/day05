        ...
        <div class="row">
			  ...
			  <div class="col-lg-2">
				<div class="input-group">
					...
					<select class="form-control" name="txt_search_mId" id = "txt_search_mId">
					...
					<form id="form_user" method="post" action="reserveUser.htm">
						...
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							<tr>
								...
								<td>&nbsp;&nbsp;</td>
								<td>学生性别：</td>
								<td><input type="radio" id="sSex1" name="sSex" value="男"
									class="" aria-required="true" required/>男
									<input type="radio" id="sSex2" name="sSex" value="女"
									class="" aria-required="true" required/>女</td>
							</tr>
							<tr>
								<td>学生爱好：</td>
								<td><input type="checkbox" id="sHobby1" name="sHobby" value="足球"
											class="" aria-required="true" required/>足球
									<input type="checkbox" id="sHobby2" name="sHobby" value="篮球"
											class="" aria-required="true" required/>篮球
									<input type="checkbox" id="sHobby3" name="sHobby" value="排球"
											class="" aria-required="true" required/>排球</td>
