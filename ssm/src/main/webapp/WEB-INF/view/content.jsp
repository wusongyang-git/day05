			  ...
			  <div class="col-lg-2">
				<div class="input-group">
					...
					<select class="form-control" name="txt_search_contentCategoryId" id = "txt_search_contentCategoryId">
						...
						<c:forEach items="${catejoryList }" var="c">
						...
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							<tr>
								...
								<td><input type="text" id="price" name="price"
									class="" aria-required="true" required/>
									</td>
							</tr>
							<tr>
								<td>广告链接：</td>
								...
								<td>&nbsp;&nbsp;</td>
								<td>广告状态：</td>
								<td><select class="form-control" name="status" id = "status" aria-required="true" required>
